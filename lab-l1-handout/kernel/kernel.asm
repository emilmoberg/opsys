...
[SYS_procinfo] sys_procinfo, // task
};
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002d52:	c5250513          	addi	a0,a0,-942 # 800169a0 <tickslock>
    80002d56:	ffffe097          	auipc	ra,0xffffe
    80002d5a:	e80080e7          	jalr	-384(ra) # 80000bd6 <acquire>
  xticks = ticks;
    80002d5e:	00006497          	auipc	s1,0x6
    80002d62:	ba24a483          	lw	s1,-1118(s1) # 80008900 <ticks>
  release(&tickslock);
    80002d66:	00014517          	auipc	a0,0x14
    80002d6a:	c3a50513          	addi	a0,a0,-966 # 800169a0 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002da2:	c1a50513          	addi	a0,a0,-998 # 800169b8 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002db2:	c0a78793          	addi	a5,a5,-1014 # 8001e9b8 <bcache+0x8000>
    80002db6:	0001c717          	auipc	a4,0x1c
    80002dba:	e6a70713          	addi	a4,a4,-406 # 8001ec20 <bcache+0x8268>
    80002dbe:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002dc2:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002dc6:	00014497          	auipc	s1,0x14
    80002dca:	c0a48493          	addi	s1,s1,-1014 # 800169d0 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80002e3a:	e3a4b483          	ld	s1,-454(s1) # 8001ec70 <bcache+0x82b8>
    80002e3e:	0001c797          	auipc	a5,0x1c
    80002e42:	de278793          	addi	a5,a5,-542 # 8001ec20 <bcache+0x8268>
    ...
    80002e6a:	b5250513          	addi	a0,a0,-1198 # 800169b8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002e88:	de44b483          	ld	s1,-540(s1) # 8001ec68 <bcache+0x82b0>
    80002e8c:	0001c797          	auipc	a5,0x1c
    80002e90:	d9478793          	addi	a5,a5,-620 # 8001ec20 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002ec8:	af450513          	addi	a0,a0,-1292 # 800169b8 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002f70:	a4c50513          	addi	a0,a0,-1460 # 800169b8 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002f98:	a2478793          	addi	a5,a5,-1500 # 8001e9b8 <bcache+0x8000>
    80002f9c:	2b87b703          	ld	a4,696(a5)
    80002fa0:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002fa2:	0001c717          	auipc	a4,0x1c
    80002fa6:	c7e70713          	addi	a4,a4,-898 # 8001ec20 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002fba:	a0250513          	addi	a0,a0,-1534 # 800169b8 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002ff2:	9ca50513          	addi	a0,a0,-1590 # 800169b8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003008:	9b450513          	addi	a0,a0,-1612 # 800169b8 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000302e:	98e50513          	addi	a0,a0,-1650 # 800169b8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003044:	97850513          	addi	a0,a0,-1672 # 800169b8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80003070:	0287a783          	lw	a5,40(a5) # 8001f094 <sb+0x1c>
...
00000000800032f2 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    8000330a:	d9250513          	addi	a0,a0,-622 # 8001f098 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000331c:	d9848493          	addi	s1,s1,-616 # 8001f0b0 <itable+0x18>
    80003320:	0001e697          	auipc	a3,0x1e
    80003324:	82068693          	addi	a3,a3,-2016 # 80020b40 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003350:	d4c50513          	addi	a0,a0,-692 # 8001f098 <itable>
  ...
  release(&itable.lock);
    ...
    80003380:	d1c50513          	addi	a0,a0,-740 # 8001f098 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    800033ce:	cae98993          	addi	s3,s3,-850 # 8001f078 <sb>
  ...
  initlog(dev, &sb);
    ...
    80003402:	c7a58593          	addi	a1,a1,-902 # 8001f078 <sb>
...
000000008000342e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003448:	c5450513          	addi	a0,a0,-940 # 8001f098 <itable>
    8000344c:	ffffd097          	auipc	ra,0xffffd
    80003450:	6fa080e7          	jalr	1786(ra) # 80000b46 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003454:	0001c497          	auipc	s1,0x1c
    80003458:	c6c48493          	addi	s1,s1,-916 # 8001f0c0 <itable+0x28>
    8000345c:	0001d997          	auipc	s3,0x1d
    80003460:	6f498993          	addi	s3,s3,1780 # 80020b50 <log+0x10>
...
000000008000348e <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800034a8:	be072703          	lw	a4,-1056(a4) # 8001f084 <sb+0xc>
    ...
    800034bc:	bc0a0a13          	addi	s4,s4,-1088 # 8001f078 <sb>
...
0000000080003560 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003578:	b1c5a583          	lw	a1,-1252(a1) # 8001f090 <sb+0x18>
...
00000000800035ee <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800035fe:	a9e50513          	addi	a0,a0,-1378 # 8001f098 <itable>
...
000000008000362c <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003676:	a1e5a583          	lw	a1,-1506(a1) # 8001f090 <sb+0x18>
...
00000000800037e6 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    800037f8:	8a450513          	addi	a0,a0,-1884 # 8001f098 <itable>
  ...
  release(&itable.lock);
    ...
    80003816:	88650513          	addi	a0,a0,-1914 # 8001f098 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    8000384a:	85250513          	addi	a0,a0,-1966 # 8001f098 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003e22:	d2290913          	addi	s2,s2,-734 # 80020b40 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003e46:	d2e78793          	addi	a5,a5,-722 # 80020b70 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003fde:	b807a923          	sw	zero,-1134(a5) # 80020b6c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004288:	8bc70713          	addi	a4,a4,-1860 # 80020b40 <log>
  ...
  release(&log.lock);
    ...
    8000429a:	8aa50513          	addi	a0,a0,-1878 # 80020b40 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800043f0:	89c50513          	addi	a0,a0,-1892 # 80020c88 <ftable>
...
filealloc(void)
{
  ...
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    ...
    80004422:	88248493          	addi	s1,s1,-1918 # 80020ca0 <ftable+0x18>
    80004426:	0001e717          	auipc	a4,0x1e
    8000442a:	81a70713          	addi	a4,a4,-2022 # 80021c40 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    8000443e:	84e50513          	addi	a0,a0,-1970 # 80020c88 <ftable>
  ...
  return 0;
    ...
    80004456:	83650513          	addi	a0,a0,-1994 # 80020c88 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000447e:	80e50513          	addi	a0,a0,-2034 # 80020c88 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004498:	7f450513          	addi	a0,a0,2036 # 80020c88 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800044d8:	7b450513          	addi	a0,a0,1972 # 80020c88 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004512:	77a50513          	addi	a0,a0,1914 # 80020c88 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    8000455c:	73050513          	addi	a0,a0,1840 # 80020c88 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    8000468e:	55e70713          	addi	a4,a4,1374 # 80020be8 <devsw>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    8000472e:	4be70713          	addi	a4,a4,1214 # 80020be8 <devsw>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    80004f2a:	01a70793          	addi	a5,a4,26 # fffffffffffff01a <end+0xffffffff7ffdd29a>
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80005000:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffdd2c4>
...
0000000080005ce8 <virtio_disk_init>:
{
  ...
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    ...
    80005d64:	75f68693          	addi	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fdc9df>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005daa:	e9a48493          	addi	s1,s1,-358 # 80021c40 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005dce:	e7e73703          	ld	a4,-386(a4) # 80021c48 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005de6:	e5e48493          	addi	s1,s1,-418 # 80021c40 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005f06:	e6650513          	addi	a0,a0,-410 # 80021d68 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f1a:	d2ab8b93          	addi	s7,s7,-726 # 80021c40 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    80005f24:	e48c8c93          	addi	s9,s9,-440 # 80021d68 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f46:	cfe70713          	addi	a4,a4,-770 # 80021c40 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005f7e:	cde50513          	addi	a0,a0,-802 # 80021c58 <disk+0x18>
    ...
    80005f8a:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    ...
    80005fa2:	ca278793          	addi	a5,a5,-862 # 80021c40 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006078:	cf490913          	addi	s2,s2,-780 # 80021d68 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    800060a4:	ba078793          	addi	a5,a5,-1120 # 80021c40 <disk>
    800060a8:	97ba                	add	a5,a5,a4
    800060aa:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    800060ae:	0001c997          	auipc	s3,0x1c
    800060b2:	b9298993          	addi	s3,s3,-1134 # 80021c40 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    800060da:	c9250513          	addi	a0,a0,-878 # 80021d68 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006112:	b3248493          	addi	s1,s1,-1230 # 80021c40 <disk>
    80006116:	0001c517          	auipc	a0,0x1c
    8000611a:	c5250513          	addi	a0,a0,-942 # 80021d68 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80006192:	bda50513          	addi	a0,a0,-1062 # 80021d68 <disk+0x128>
...
uint64 sys_procinfo(void) {
    800061b8:	7179                	addi	sp,sp,-48
    800061ba:	f406                	sd	ra,40(sp)
    800061bc:	f022                	sd	s0,32(sp)
    800061be:	ec26                	sd	s1,24(sp)
    800061c0:	e84a                	sd	s2,16(sp)
    800061c2:	e44e                	sd	s3,8(sp)
    800061c4:	e052                	sd	s4,0(sp)
    800061c6:	1800                	addi	s0,sp,48
    
    struct proc *p;

    printf("\n");
    800061c8:	00002517          	auipc	a0,0x2
    800061cc:	f0050513          	addi	a0,a0,-256 # 800080c8 <digits+0x88>
    800061d0:	ffffa097          	auipc	ra,0xffffa
    800061d4:	3ba080e7          	jalr	954(ra) # 8000058a <printf>
    for(p = proc; p < &proc[NPROC]; p++){
    800061d8:	0000b497          	auipc	s1,0xb
    800061dc:	f2048493          	addi	s1,s1,-224 # 800110f8 <proc+0x158>
    800061e0:	00011917          	auipc	s2,0x11
    800061e4:	91890913          	addi	s2,s2,-1768 # 80016af8 <bcache+0x140>
        if(p->state == UNUSED)
            continue;
        printf("%s (%d): %d", p->name, p->pid, p->state);
    800061e8:	00002a17          	auipc	s4,0x2
    800061ec:	660a0a13          	addi	s4,s4,1632 # 80008848 <syscalls+0x3f8>
        printf("\n");
    800061f0:	00002997          	auipc	s3,0x2
    800061f4:	ed898993          	addi	s3,s3,-296 # 800080c8 <digits+0x88>
    800061f8:	a029                	j	80006202 <sys_procinfo+0x4a>
    for(p = proc; p < &proc[NPROC]; p++){
    800061fa:	16848493          	addi	s1,s1,360
    800061fe:	03248363          	beq	s1,s2,80006224 <sys_procinfo+0x6c>
        if(p->state == UNUSED)
    80006202:	ec04a683          	lw	a3,-320(s1)
    80006206:	daf5                	beqz	a3,800061fa <sys_procinfo+0x42>
        printf("%s (%d): %d", p->name, p->pid, p->state);
    80006208:	ed84a603          	lw	a2,-296(s1)
    8000620c:	85a6                	mv	a1,s1
    8000620e:	8552                	mv	a0,s4
    80006210:	ffffa097          	auipc	ra,0xffffa
    80006214:	37a080e7          	jalr	890(ra) # 8000058a <printf>
        printf("\n");
    80006218:	854e                	mv	a0,s3
    8000621a:	ffffa097          	auipc	ra,0xffffa
    8000621e:	370080e7          	jalr	880(ra) # 8000058a <printf>
    80006222:	bfe1                	j	800061fa <sys_procinfo+0x42>
    }
    ...
    8000622e:	69a2                	ld	s3,8(sp)
    80006230:	6a02                	ld	s4,0(sp)
